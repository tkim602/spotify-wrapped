...
public class Signup extends AppCompatActivity {
    ...
    public void getToken() {
        ...
        AuthorizationClient.openLoginActivity(Signup.this, AUTH_TOKEN_REQUEST_CODE, request);
    }
    ...
    public void getCode() {
        ...
        AuthorizationClient.openLoginActivity(Signup.this, AUTH_CODE_REQUEST_CODE, request);
    }
    ...
    public void onGetUserProfileClicked() {
        ...
        mCall.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Toast.makeText(Signup.this, "Failed to fetch data, watch Logcat for more details",
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    Toast.makeText(Signup.this, "Failed to parse data, watch Logcat for more details",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
